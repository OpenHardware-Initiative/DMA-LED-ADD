...
#ifndef _bd_9332_slot_1_w_0_core_h_
#define _bd_9332_slot_1_w_0_core_h_
...
class bd_9332_slot_1_w_0_core : public sc_module 
{
    public: 
       bd_9332_slot_1_w_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(bd_9332_slot_1_w_0_core);
    ...
    virtual ~bd_9332_slot_1_w_0_core() = default;
