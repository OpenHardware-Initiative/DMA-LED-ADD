...
//--------------------------------------------------------------------------------
//Command: generate_target bd_9332.bd
//Design : bd_9332
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_9332,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_9332,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "DMA_ADDER_system_ila_0_0.hwdef" *) 
module bd_9332
   (SLOT_0_AXIS_tdata,
    SLOT_0_AXIS_tlast,
    SLOT_0_AXIS_tready,
    ...
    probe1,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 SLOT_0_AXIS TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN DMA_ADDER_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 99999001, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]SLOT_0_AXIS_tdata;
  ...
  bd_9332_ila_lib_0 ila_lib
       (.clk(clk_1),
        .probe0(probe0_1),
        .probe1(probe1_1),
        .probe10(net_slot_1_axi_arlen),
        .probe11(net_slot_1_axi_arprot),
        .probe12(net_slot_1_axi_arsize),
        .probe13(net_slot_1_axi_aw_cnt),
        .probe14(net_slot_1_axi_b_cnt),
        .probe15(net_slot_1_axi_r_cnt),
        .probe16(net_slot_1_axi_rdata),
        .probe17(net_slot_1_axi_rresp),
        .probe18(net_slot_1_axi_aw_ctrl),
        .probe19(net_slot_1_axi_w_ctrl),
        .probe2(net_slot_0_axis_tdata),
        .probe20(net_slot_1_axi_b_ctrl),
        .probe21(net_slot_1_axi_ar_ctrl),
        .probe22(net_slot_1_axi_r_ctrl),
        .probe23(net_slot_2_axi_ar_cnt),
        .probe24(net_slot_2_axi_aw_cnt),
        .probe25(net_slot_2_axi_awaddr),
        .probe26(net_slot_2_axi_awcache),
        .probe27(net_slot_2_axi_awlen),
        .probe28(net_slot_2_axi_awprot),
        .probe29(net_slot_2_axi_awsize),
        .probe3(net_slot_0_axis_tstrb),
        .probe30(net_slot_2_axi_b_cnt),
        .probe31(net_slot_2_axi_bresp),
        .probe32(net_slot_2_axi_r_cnt),
        .probe33(net_slot_2_axi_wdata),
        .probe34(net_slot_2_axi_wstrb),
        .probe35(net_slot_2_axi_aw_ctrl),
        .probe36(net_slot_2_axi_w_ctrl),
        .probe37(net_slot_2_axi_b_ctrl),
        .probe38(net_slot_2_axi_ar_ctrl),
        .probe39(net_slot_2_axi_r_ctrl),
        .probe4(net_slot_0_axis_tvalid),
        .probe40(net_slot_3_axis_tdata),
        .probe41(net_slot_3_axis_tkeep),
        .probe42(net_slot_3_axis_tvalid),
        .probe43(net_slot_3_axis_tready),
        .probe44(net_slot_3_axis_tlast),
        .probe5(net_slot_0_axis_tready),
        .probe6(net_slot_0_axis_tlast),
        .probe7(net_slot_1_axi_ar_cnt),
        .probe8(net_slot_1_axi_araddr),
        .probe9(net_slot_1_axi_arcache));
  bd_9332_slot_1_ar_0 slot_1_ar
       (.In0(net_slot_1_axi_arvalid),
        .In1(net_slot_1_axi_arready),
        .dout(net_slot_1_axi_ar_ctrl));
  bd_9332_slot_1_aw_0 slot_1_aw
       (.In0(net_slot_1_axi_awvalid),
        .In1(net_slot_1_axi_awready),
        .dout(net_slot_1_axi_aw_ctrl));
  bd_9332_slot_1_b_0 slot_1_b
       (.In0(net_slot_1_axi_bvalid),
        .In1(net_slot_1_axi_bready),
        .dout(net_slot_1_axi_b_ctrl));
  bd_9332_slot_1_r_0 slot_1_r
       (.In0(net_slot_1_axi_rvalid),
        .In1(net_slot_1_axi_rready),
        .In2(net_slot_1_axi_rlast),
        .dout(net_slot_1_axi_r_ctrl));
  bd_9332_slot_1_w_0 slot_1_w
       (.In0(net_slot_1_axi_wvalid),
        .In1(net_slot_1_axi_wready),
        .In2(net_slot_1_axi_wlast),
        .dout(net_slot_1_axi_w_ctrl));
  bd_9332_slot_2_ar_0 slot_2_ar
       (.In0(net_slot_2_axi_arvalid),
        .In1(net_slot_2_axi_arready),
        .dout(net_slot_2_axi_ar_ctrl));
  bd_9332_slot_2_aw_0 slot_2_aw
       (.In0(net_slot_2_axi_awvalid),
        .In1(net_slot_2_axi_awready),
        .dout(net_slot_2_axi_aw_ctrl));
  bd_9332_slot_2_b_0 slot_2_b
       (.In0(net_slot_2_axi_bvalid),
        .In1(net_slot_2_axi_bready),
        .dout(net_slot_2_axi_b_ctrl));
  bd_9332_slot_2_r_0 slot_2_r
       (.In0(net_slot_2_axi_rvalid),
        .In1(net_slot_2_axi_rready),
        .In2(net_slot_2_axi_rlast),
        .dout(net_slot_2_axi_r_ctrl));
  bd_9332_slot_2_w_0 slot_2_w
