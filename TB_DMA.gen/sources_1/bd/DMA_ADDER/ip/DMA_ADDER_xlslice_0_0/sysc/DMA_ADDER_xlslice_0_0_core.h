...
#ifndef _DMA_ADDER_xlslice_0_0_core_h_
#define _DMA_ADDER_xlslice_0_0_core_h_

#include <systemc.h>
#include "properties.h"


class DMA_ADDER_xlslice_0_0_core : public sc_module 
{
    public: 
       DMA_ADDER_xlslice_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(DMA_ADDER_xlslice_0_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~DMA_ADDER_xlslice_0_0_core() = default;
