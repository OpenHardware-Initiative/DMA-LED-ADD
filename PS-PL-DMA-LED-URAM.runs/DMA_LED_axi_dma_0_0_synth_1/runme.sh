...
HD_PWD='/nas/ei/home/ge43set/PS-PL-DMA-LED-URAM/PS-PL-DMA-LED-URAM.runs/DMA_LED_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_LED_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_LED_axi_dma_0_0.tcl
