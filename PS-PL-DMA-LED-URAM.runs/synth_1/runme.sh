...
HD_PWD='/nas/ei/home/ge43set/PS-PL-DMA-LED-URAM/PS-PL-DMA-LED-URAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_LED_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DMA_LED_wrapper.tcl
