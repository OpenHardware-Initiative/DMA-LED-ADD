...
HD_PWD='/nas/ei/home/ge43set/PS-PL-DMA-LED-URAM/PS-PL-DMA-LED-URAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DMA_LED_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DMA_LED_wrapper.tcl -notrace
