...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L zynq_ultra_ps_e_vip_v1_0_17 -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_10 -L lib_fifo_v1_0_19 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_33 -L axi_sg_v4_1_18 -L axi_dma_v7_1_32 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_15 -L smartconnect_v1_0 -L axi_register_slice_v2_1_31 -L xlconcat_v2_1_6 -L xlslice_v1_0_4 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_30 -L axi_crossbar_v2_1_32 -L axi_protocol_converter_v2_1_31 -L gigantic_mux -L axi_jtag_v1_0_2 -L bsip_v1_1_1 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DMA_ADDER xil_defaultlib.DMA_ADDER xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DMA_ADDER -key {Behavioral:sim_1:Functional:DMA_ADDER} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_037c.protoinst" -protoinst "protoinst_files/bd_9332.protoinst" -protoinst "protoinst_files/bd_8f93.protoinst" -protoinst "protoinst_files/DMA_ADDER.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/coppholl/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DMA_ADDER.wdb xsim.dir libdpi.so)
