...
-- Date        : Thu Aug 21 22:25:06 2025
-- Host        : coppholl running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top DMA_ADDER_ADDER_0_0 -prefix
--               DMA_ADDER_ADDER_0_0_ DMA_ADDER_ADDER_0_0_sim_netlist.vhdl
-- Design      : DMA_ADDER_ADDER_0_0
...
entity DMA_ADDER_ADDER_0_0_LEDAdderDMA_master_stream_v1_0_M00_AXIS is
  port (
    m00_axis_tvalid : out STD_LOGIC;
    m00_axis_tlast : out STD_LOGIC;
    m00_axis_tdata : out STD_LOGIC_VECTOR ( 16 downto 0 );
    m00_axis_aclk : in STD_LOGIC;
    D : in STD_LOGIC_VECTOR ( 16 downto 0 );
    m00_axis_aresetn : in STD_LOGIC;
    m00_axis_tready : in STD_LOGIC
  );
end DMA_ADDER_ADDER_0_0_LEDAdderDMA_master_stream_v1_0_M00_AXIS;

architecture STRUCTURE of DMA_ADDER_ADDER_0_0_LEDAdderDMA_master_stream_v1_0_M00_AXIS is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_mst_exec_state_reg[0]\ : label is "IDLE:00,SEND_STREAM:10,INIT_COUNTER:01";
  attribute FSM_ENCODED_STATES of \FSM_sequential_mst_exec_state_reg[1]\ : label is "IDLE:00,SEND_STREAM:10,INIT_COUNTER:01";
...
\read_pointer[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_lite_v1_0_S00_AXI is
  port (
...
end DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_lite_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state_write[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \FSM_sequential_state_write[1]_i_2\ : label is "soft_lutpair6";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_stream_v1_0_S00_AXIS is
  port (
...
end DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_stream_v1_0_S00_AXIS;

architecture STRUCTURE of DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_stream_v1_0_S00_AXIS is
...
\data_in_adder_reg[16]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(0),
...
\data_in_adder_reg[17]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(1),
...
\data_in_adder_reg[18]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(2),
...
\data_in_adder_reg[19]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(3),
...
\data_in_adder_reg[20]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(4),
...
\data_in_adder_reg[21]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(5),
...
\data_in_adder_reg[22]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(6),
...
\data_in_adder_reg[23]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(7),
...
\data_in_adder_reg[24]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(8),
...
\data_in_adder_reg[25]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(9),
...
\data_in_adder_reg[26]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(10),
...
\data_in_adder_reg[27]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(11),
...
\data_in_adder_reg[28]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(12),
...
\data_in_adder_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(13),
...
\data_in_adder_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(14),
...
\data_in_adder_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => s00_axis_tdata(15),
...
enable_adder_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axis_aclk,
      CE => \^e\(0),
      D => '1',
...
\led1[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DMA_ADDER_ADDER_0_0_adder_IP is
  port (
...
end DMA_ADDER_ADDER_0_0_adder_IP;

architecture STRUCTURE of DMA_ADDER_ADDER_0_0_adder_IP is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity DMA_ADDER_ADDER_0_0_ADDER is
  port (
    led0 : out STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
...
end DMA_ADDER_ADDER_0_0_ADDER;

architecture STRUCTURE of DMA_ADDER_ADDER_0_0_ADDER is
  signal adder_IP_inst_n_0 : STD_LOGIC;
  signal adder_IP_inst_n_1 : STD_LOGIC;
  signal adder_IP_inst_n_10 : STD_LOGIC;
  signal adder_IP_inst_n_11 : STD_LOGIC;
  signal adder_IP_inst_n_12 : STD_LOGIC;
  signal adder_IP_inst_n_13 : STD_LOGIC;
  signal adder_IP_inst_n_14 : STD_LOGIC;
  signal adder_IP_inst_n_15 : STD_LOGIC;
  signal adder_IP_inst_n_16 : STD_LOGIC;
  signal adder_IP_inst_n_2 : STD_LOGIC;
  signal adder_IP_inst_n_3 : STD_LOGIC;
  signal adder_IP_inst_n_4 : STD_LOGIC;
  signal adder_IP_inst_n_5 : STD_LOGIC;
  signal adder_IP_inst_n_6 : STD_LOGIC;
  signal adder_IP_inst_n_7 : STD_LOGIC;
  signal adder_IP_inst_n_8 : STD_LOGIC;
  signal adder_IP_inst_n_9 : STD_LOGIC;
  signal data_in_adder : STD_LOGIC_VECTOR ( 31 downto 16 );
  signal enable_adder : STD_LOGIC;
  signal p_0_in : STD_LOGIC;
begin
LEDAdderDMA_master_stream_v1_0_M00_AXIS_inst: entity work.DMA_ADDER_ADDER_0_0_LEDAdderDMA_master_stream_v1_0_M00_AXIS
     port map (
      D(16) => adder_IP_inst_n_0,
      D(15) => adder_IP_inst_n_1,
      D(14) => adder_IP_inst_n_2,
      D(13) => adder_IP_inst_n_3,
      D(12) => adder_IP_inst_n_4,
      D(11) => adder_IP_inst_n_5,
      D(10) => adder_IP_inst_n_6,
      D(9) => adder_IP_inst_n_7,
      D(8) => adder_IP_inst_n_8,
      D(7) => adder_IP_inst_n_9,
      D(6) => adder_IP_inst_n_10,
      D(5) => adder_IP_inst_n_11,
      D(4) => adder_IP_inst_n_12,
      D(3) => adder_IP_inst_n_13,
      D(2) => adder_IP_inst_n_14,
      D(1) => adder_IP_inst_n_15,
      D(0) => adder_IP_inst_n_16,
...
LEDAdderDMA_slave_lite_v1_0_S00_AXI_inst: entity work.DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_lite_v1_0_S00_AXI
     port map (
...
LEDAdderDMA_slave_stream_v1_0_S00_AXIS_inst: entity work.DMA_ADDER_ADDER_0_0_LEDAdderDMA_slave_stream_v1_0_S00_AXIS
     port map (
      E(0) => led1(0),
      Q(15 downto 0) => data_in_adder(31 downto 16),
...
adder_IP_inst: entity work.DMA_ADDER_ADDER_0_0_adder_IP
     port map (
      D(16) => adder_IP_inst_n_0,
      D(15) => adder_IP_inst_n_1,
      D(14) => adder_IP_inst_n_2,
...
entity DMA_ADDER_ADDER_0_0 is
  ...
  attribute NotValidForBitStream of DMA_ADDER_ADDER_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of DMA_ADDER_ADDER_0_0 : entity is "DMA_ADDER_ADDER_0_0,ADDER,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of DMA_ADDER_ADDER_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of DMA_ADDER_ADDER_0_0 : entity is "ADDER,Vivado 2024.1";
end DMA_ADDER_ADDER_0_0;

architecture STRUCTURE of DMA_ADDER_ADDER_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of m00_axis_aclk : signal is "XIL_INTERFACENAME M00_AXIS_CLK, ASSOCIATED_BUSIF M00_AXIS, ASSOCIATED_RESET m00_axis_aresetn, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN DMA_ADDER_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m00_axis_aresetn : signal is "xilinx.com:signal:reset:1.0 M00_AXIS_RST RST";
  attribute X_INTERFACE_PARAMETER of m00_axis_aresetn : signal is "XIL_INTERFACENAME M00_AXIS_RST, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m00_axis_tlast : signal is "xilinx.com:interface:axis:1.0 M00_AXIS TLAST";
  attribute X_INTERFACE_INFO of m00_axis_tready : signal is "xilinx.com:interface:axis:1.0 M00_AXIS TREADY";
  attribute X_INTERFACE_PARAMETER of m00_axis_tready : signal is "XIL_INTERFACENAME M00_AXIS, WIZ_DATA_WIDTH 32, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 1, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 99999001, PHASE 0.0, CLK_DOMAIN DMA_ADDER_zynq_ultra_ps_e_0_0_pl_clk0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m00_axis_tvalid : signal is "xilinx.com:interface:axis:1.0 M00_AXIS TVALID";
  attribute X_INTERFACE_INFO of s00_axi_aclk : signal is "xilinx.com:signal:clock:1.0 S00_AXI_CLK CLK";
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN DMA_ADDER_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s00_axis_aclk : signal is "XIL_INTERFACENAME S00_AXIS_CLK, ASSOCIATED_BUSIF S00_AXIS, ASSOCIATED_RESET s00_axis_aresetn, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN DMA_ADDER_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
...
inst: entity work.DMA_ADDER_ADDER_0_0_ADDER
     port map (
      ...
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
      m00_axis_tdata(16 downto 1) => \^m00_axis_tdata\(31 downto 16),
      m00_axis_tdata(0) => \^m00_axis_tdata\(0),
      m00_axis_tlast => m00_axis_tlast,
      m00_axis_tready => m00_axis_tready,
      m00_axis_tvalid => m00_axis_tvalid,
